 ...
 * 
 * 	메서드 구조
 * 		(접근 제한자) (static) 반환타입 메서드이름 (매개변수타입 매개변수명){
 * 			실행할 코드(명령문 집합)
 * 
 * 			(return 반환값;)
 *  
 ...
 * 
 * ******오버로딩(Overloading)
 * 	클라스 내에서 같은 이름을 가진 메서드를 여러개 정의하는 것을 말한다.
...
public class Method01 {
	public static void main(String[] args) {
		...
		method01.hello(); // hello() 메서드호출 (call a method)
		printName("야가오");
	...
	//2. 인자 o 리턴 x ->  
	public static void printName(String name) {//String name = "야가오";
	...
	//매개변수 중 단 하나만 타입이 다르거나 개수가 다르면 메서드 이름이 같아도 사용 가능.
