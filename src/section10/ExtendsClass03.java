...
/*
 * 패키지(Package)
 * 	관련된 클래스, 인터페이스 등을 그룹화하는데 사용되는 디렉토리
 * 	
 * 	이름충돌 방지: 같은이름의 클래스, 인터페이스 패키지를 달리하여 충돌 방지.
 * 	코드 구조화: 관련된 클래스를 패키지 단위로 그룹화.
 * 	접근 제어: 클래스나 멤버에 접근제한자를 적용하여, 해당 패키지외부에서 접근제한 가능.
 * 
...
public class ExtendsClass03 {
	public static void main(String[] args) {
		Car car = new Car();
		car.model = "제네시스 GV80";
//		car.color = "black"; 	//protected 다른 패키지 접근 불가
